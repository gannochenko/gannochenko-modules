...
export const muiBreakpointUp = (breakpointName: BreakpointNameType) => ({
    theme,
}: StylePropsType) => theme.breakpoints.up(breakpointName);
export const muiBreakpointDown = (breakpointName: BreakpointNameType) => ({
    theme,
}: StylePropsType) => theme.breakpoints.down(breakpointName);
